...
(function() {
  var NvramArm, NvramParser, fs, iced, isGzip, zlib, __iced_k, __iced_k_noop,
    __slice = [].slice;
  ...
  NvramParser = (function() {
    ...
    NvramParser.separator = Buffer.from("00", "hex");
    ...
    NvramParser.validate = function(buf) {
      ...
      if (!(h = buf.slice(0, +(this.headerbuf.length - 1) + 1 || 9e9)).equals(this.headerbuf)) {
        return "header \"" + h + "\" does not match expected NVRAM cfg format -- aborting";
      }
      if (!(f = buf.slice(-this.footerbuf.length)).equals(this.footerbuf)) {
    ...
    NvramParser.parse = function(buf) {
      ...
      settings = {};
      while (body.length) {
        bound = body.indexOf(NvramParser.separator);
        if (bound > -1) {
    ...
    NvramParser.encode = function(filename, format, autocb) {
      var encoded, json, key, pair, pairs, settings, value, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = autocb;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      if (format == null) {
        format = "original";
      ...
      pairs = (function() {
        ...
        for (key in settings) {
          ...
          _results.push(Buffer.concat([pair, this.separator]));
        }
        return _results;
      }).call(NvramParser);
      (function(__iced_k) {
    ...
    NvramParser.encodeOriginal = function(pairs, autocb) {
      ...
      __iced_k = autocb;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      buf = Buffer.concat([NvramParser.headerbuf].concat(__slice.call(pairs), [NvramParser.footerbuf]));
      (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          parent: ___iced_passed_deferral,
          filename: "/home/charles/source/nvram-cfg-parser/src/nvram-parser.iced",
